...
- 🧱 **18 built-in segments.** Model, context, directory and git, session,
...
installer reports what it replaced.
...
- **[Configuration](docs/CONFIGURATION.md)** — the layout model, all 18 segments
