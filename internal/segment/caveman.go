...
// openFlagFile refuse both at syscall on unix; handle's own Stat close rest of
// window everywhere, identity checked on opened handle, not on name.
//
